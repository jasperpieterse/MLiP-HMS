...
This repository contains the code for the **HMS - Harmful Brain Activity Classification Kaggle Competition**. We implemented various deep learning models to **detect and classify seizuresy** using **electroencephalography (EEG) signals** and their corresponding **spectrograms** recorded from critically ill hospital patients. More details about the competition can be found on the [Kaggle competition page](https://www.kaggle.com/competitions/hms-harmful-brain-activity-classification).  
